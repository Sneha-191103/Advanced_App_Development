...
public class MyConstant {
        ...
        // Swagger Info
        public static final String SWAGGER_INFO_TITLE = "CELEBRATE WITH US";
        public static final String SWAGGER_INFO_DESCRIPTION = "This is a sample CELEBRATE WITH US documentation";
        public static final String SWAGGER_INFO_VERSION = "1.0.0";
        public static final String SWAGGER_INFO_CONTACT_NAME = "Sneha";
        public static final String SWAGGER_INFO_CONTACT_EMAIL = "sneha@example.com";
